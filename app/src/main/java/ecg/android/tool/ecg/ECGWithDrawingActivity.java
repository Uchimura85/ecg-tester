...
public class ECGWithDrawingActivity extends BleProfileActivity implements ECGManagerCallbacks, OnChartValueSelectedListener {
...
//                }
            ...
            // n page show
            if (set.getEntryCount() > X_LENGTH * 50) {
                for (int j = 0; j < 100; j++) {
                    set.removeFirst();
//                    setX.removeFirst();
//                    setY.removeFirst();
