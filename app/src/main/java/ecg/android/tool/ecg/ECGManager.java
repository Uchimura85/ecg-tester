...
//			if (isHeartRateInUINT16(characteristic.getValue()[0]) || false)
//			if (true)
//			{
...
//					mCallbacks.onHRValueReceived(gatt.getDevice(), hrValue,isSensorDetected);
					...
					mCallbacks.onAccDataReceived(new AccData(hrValue,accX, accY, accZ),isSensorDetected);
				}
...
//			}
	...
	private  boolean isHeartRateInArray(final byte value){ return  ((value & 0x01)!= 0);}
