...
package ecg.android.tool.scanner;
	...
	public View getView(int position, View oldView, ViewGroup parent) {
		...
		default:
			...
			if (!device.isBonded || device.rssi != ExtendedBluetoothDevice.NO_RSSI) {
				...
				TextView tv = (TextView) view.findViewById(R.id.rssivalue);
				//TextView device_name = (TextView) view.findViewById(R.id.device_name);
				//device_name.setText("rssi:   "+ rssiPercent);
				//tv.setText(""+rssiPercent+":"+device.rssi);
